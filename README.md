...
### Jurisprudência do TJGO para Claude, Cursor e agentes de IA
...
- ⚖️ **TJGO** e mais 16 tribunais na mesma conexão, incluindo STF, STJ e TST
...
**Manual** (se o deeplink não abrir): [claude.ai/customize/connectors](https://claude.ai/customize/connectors?surface=cowork) → **+** → **Adicionar conector personalizado** → cole **Nome** `Jurisprudência TJGO` e **URL** `https://api.mcp.ai/p_tjgo`.

### Cursor

[➕ Instalar Jurisprudência TJGO no Cursor](cursor://anysphere.cursor-deeplink/mcp/install?name=tjgo&config=eyJ1cmwiOiJodHRwczovL2FwaS5tY3AuYWkvcF90amdvIn0=)

### VS Code (Copilot Chat)

[➕ Instalar Jurisprudência TJGO no VS Code](vscode:mcp/install?name=tjgo&config=%7B%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fapi.mcp.ai%2Fp_tjgo%22%7D)
...
MIT — veja [LICENSE](LICENSE). O servidor MCP em `api.mcp.ai/p_tjgo` é proprietário (hosted); este repositório (manifestos, docs, skills) é MIT.
